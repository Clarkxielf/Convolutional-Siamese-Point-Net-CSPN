...
def RegistrationNet_arguments():
    ...
    parser.add_argument('--dataset', default='blade1_S3_inference_data_{}*.mat',
                        choices=['0.1_blade1_32data_2d_{}*.mat', 'blade1_S1_inference_data_{}*.mat'],
                        help='dataset (default: blade1_64data_2d_{}*.mat).'
                             '\'blade1_64data_2d_{}*.mat\' used for training.'
                             '\'blade1_64data_2d_inspection_data_{}*.mat\' used for both inference and evaluation')
    # parser.add_argument('--resume', default=None, type=str, metavar='PATH',
    #                     help='Pretrained network to load from. Optional for train, required for inference.')
    parser.add_argument('--resume', default='../logs/220429_191157_blade1/ckpt', type=str, metavar='PATH',
                        help='Pretrained network to load from. Optional for train, required for inference.')
    parser.add_argument('--num_points', default=32, type=int,
    ...
    # DGCNN settings
    parser.add_argument('--num_neighbors', type=int, default=4, metavar='N', help='Max num of neighbors to use')
    ...
    # Training parameters
    parser.add_argument('--train_batch_size', default=64, type=int, metavar='N',
                        help='training mini-batch size (default: 8)')
    parser.add_argument('-b', '--val_batch_size', default=64, type=int, metavar='N',
    ...
    parser.add_argument('--num_train_reg_iter', type=int, default=3,
