...
inspection_data = sio.loadmat('./blade3_S1_View.mat')['View'][:, :2]
...
sio.savemat('./blade3_S1_inference_data_test0.mat',
            {'Src': all_Src,
             'Ref': all_Ref,
...
plt.show()
sio.savemat('./blade3_S1_preprocess.mat',
...
sio.savemat('./blade3_S1_inference_data_Segmented_idx.mat',
