...
inspection_data = sio.loadmat('./blade1_S1_View.mat')['View'][:, :2]
...
src = segmented_data0[-200:-200+32]
...
sio.savemat('./blade1_S1_inference_data_test0.mat',
            {'Src': all_Src,
             'Ref': all_Ref,
...
plt.show()
sio.savemat('./blade1_S1_preprocess.mat',
...
sio.savemat('./blade1_S1_inference_data_Segmented_idx.mat',
