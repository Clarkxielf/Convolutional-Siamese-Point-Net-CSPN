...
inspection_data = sio.loadmat('./blade1_S3_View.mat')['View'][:, :2]
...
src = segmented_data1[-100:-100+32]
...
sio.savemat('./blade1_S3_inference_data_test0.mat',
            {'Src': all_Src,
             'Ref': all_Ref,
...
plt.show()
sio.savemat('./blade1_S3_preprocess.mat',
...
sio.savemat('./blade1_S3_inference_data_Segmented_idx.mat',
